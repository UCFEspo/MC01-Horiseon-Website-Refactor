# Module 1 Challenge - Refactoring the Horiseon Website Code
...
2. Above the list of files, click <> **Code**.
   ...
   ![Module 1 Challenge - Refactoring the Horiseon Website Code-2](./assets/images/GitHub-Green-Code-0Button.png)
